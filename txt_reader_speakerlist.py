# -*- coding: utf-8 -*-
"""txt_reader(speakerlist).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1WVaY__5mYMc-3EN8VJonjE9vj-f--JiR
"""
...
def convert_to_korea(speaker_list, speaker_list2__, dialog_json, id):
    # k = 0
    id = "SBRW 2100000001"
...
korea_formatted_data = convert_to_korea(
    speaker_list, speaker_list2__, dialog_json, id)
...
def speaker_id_json(id):
    ...
    k = 0
    files = sorted(glob(
        "/Users/jaewanpark/Documents/회의록/pm_summary_preprocessor(pjw)/요약대상회의록-1차/*.txt"))
    for fname in files:
        with open(fname, 'r', encoding='utf-8-sig') as file:
            txt = file.readlines()
            pass
