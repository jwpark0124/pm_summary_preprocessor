...
# fname = "/Users/jaewanpark/Documents/회의록/회의록 1차 2차 분류/1차/346외통(법안심사)소위02(16.10.28.).txt"
# fname = "/Users/jaewanpark/Documents/회의록/회의록 1차 2차 분류/1차/347안행(안전및선거법심사)소위01(16.12.20.).txt"
# fname = "/Users/jaewanpark/Documents/회의록/회의록 1차 2차 분류/1차/354환노(고용노동)소위03(17.9.28.).txt"
# fname = "/Users/jaewanpark/Documents/회의록/회의록 1차 2차 분류/1차/337교문(예산결산기금심사)소위01(15.11.2).txt"
...
def convert_to_korea(meta, speaker_list, speaker_list2, dialog_json, id):
    # k = 0
    id = "SBRW 2100000001"
    ...
    doc_metadata['speaker'] = speaker_list + speaker_list2
