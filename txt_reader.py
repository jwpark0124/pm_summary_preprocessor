...
Original file is located at
    https://colab.research.google.com/drive/1P4wvJ_caG7rda08kwfCDOfM7s7GsBO9_
"""
...
fname = "/Users/jaewanpark/Documents/회의록/pm_summary_preprocessor(pjw)/요약대상회의록-2차/311재정(예산결산기금심사)소위09(12.11.20).txt"
...
korea_formatted_data = convert_to_korea(
    meta, speaker_list, speaker_list__, speaker_list2__2, dialog_json, id)
...
def csv_extractor(id):
    ...
    for fname in files:
        ...
        with open("/Users/jaewanpark/Documents/회의록/pm_summary_preprocessor(pjw)/mapping_table/1차-mapping_table.csv", 'wt', encoding='utf-8-sig', newline='') as out_file:
